...
public class WalletTest {
	...
	public static void generalSetup() throws ConfigurationException {
		...
		walletId = config.getString("wallet");
...
//
//		account.getBalance();
//		assertEquals(new BigInteger("5191855022866341132517769216"), account.getBalance());
//		assertEquals(new BigInteger("5191855022866341132517769216"), wallet.getBalance());
//	}
}
